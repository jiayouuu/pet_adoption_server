...
import com.jiayou.pet.utils.EmailUtil;
import com.jiayou.pet.utils.JwtUtil;
import com.jiayou.pet.utils.RedisUtil;
...
public class ValidateServiceImpl implements ValidateService {
    ...
    @Override
    public R validateImgCode(String id, String code) {
        HashMap<String, Object> map = new HashMap<>();
    ...
    public R sendEmailCode(String email) {
        ...
        if (preCode != null) {
            return R.error(400, "验证码仍处于有效期，请勿重复请求");
        }
    ...
    @Override
    public R validateEmailCode(String email, String code) {
        HashMap<String, Object> map = new HashMap<>();
